...
function consentForm_1RoutineBegin(snapshot) {
  return async function () {
    ...
    consentForm_1Components.forEach( function(thisComponent) {
...
function consentForm_2RoutineBegin(snapshot) {
  return async function () {
    ...
    consentForm_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function exclusionRoutineBegin(snapshot) {
  return async function () {
    ...
    exclusionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instructColorRoutineBegin(snapshot) {
  return async function () {
    ...
    instructColorComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function loop10_colorblindLoopBegin(loop10_colorblindLoopScheduler, snapshot) {
  return async function() {
    ...
    loop10_colorblind.forEach(function() {
...
function RG_colorblindRoutineBegin(snapshot) {
  return async function () {
    ...
    RG_colorblindComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instructTrialRoutineBegin(snapshot) {
  return async function () {
    ...
    instructTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function both_trialsRoutineBegin(snapshot) {
  return async function () {
    ...
    both_trialsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function PreMEQRoutineBegin(snapshot) {
  return async function () {
    ...
    PreMEQComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function bestfeel_meqRoutineBegin(snapshot) {
  return async function () {
    ...
    bestfeel_meqComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function wokentired_meqRoutineBegin(snapshot) {
  return async function () {
    ...
    wokentired_meqComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function sleepytime_meqRoutineBegin(snapshot) {
  return async function () {
    ...
    sleepytime_meqComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function bestpeak_meqRoutineBegin(snapshot) {
  return async function () {
    ...
    bestpeak_meqComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function persontype_meqRoutineBegin(snapshot) {
  return async function () {
    ...
    persontype_meqComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function what_ageRoutineBegin(snapshot) {
  return async function () {
    ...
    what_ageComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function race_ethnRoutineBegin(snapshot) {
  return async function () {
    ...
    race_ethnComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
